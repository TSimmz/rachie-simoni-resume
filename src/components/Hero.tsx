...
const Hero = () => {
  return (
    <section className="flex flex-col w-full">
      <motion.h1
        layout
        className="font-bold text-left text-8xl sm:text-9xl md:text-[25vmin] lg:text-[35vmin] w-full lg:leading-[35vmin]"
      >
        Hello!
      </motion.h1>

      <div className="flex flex-col-reverse md:flex-row p-1 md:p-[18px] gap-8">
        <div>
          <svg
            viewBox="0 0 50 50"
            stroke="none"
        ...
        <article className="flex flex-col gap-1 md:gap-2">
          <h2 className="font-semibold text-3xl md:text-6xl">
            I&apos;m Rachie Simoni
          </h2>
          <p className="text-lg md:text-3xl italic">
            Freelance Digital Marketing + Content
          </p>

          <div className="flex flex-col md:gap-2 mt-4">
            <p className="text-lg md:text-3xl">
              <svg
                viewBox="0 0 24 24"
                fill="white"
                className="inline-block h-5 w-5 md:h-8 md:w-8 mr-4"
              >
